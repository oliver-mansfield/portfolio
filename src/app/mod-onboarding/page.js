...
export default function Page() {
  return (
    <main className="border-[1px] border-black border-t-0 p-8 bg-grayLight flex items-center flex-col">
      ...
      <section className='w-full md:max-w-[1200px]'>
        ...
        <div className='flex justify-between'>
          ...
          <div className='w-1/2'>
            ...
            <Image src="/images/mod-tablet1.png" alt="MOD Forms" width={690} height={526} quality={100} layout='cover' className='border-black border-[2px] rounded-md overflow-hidden' />

          </div>
          <div className='w-1/2'>
            <Image src="/images/mod-mobile1.png" alt="MOD Forms" width={350} height={526} quality={100} layout='cover' className='border-black border-[2px] rounded-md overflow-hidden mx-auto' />
